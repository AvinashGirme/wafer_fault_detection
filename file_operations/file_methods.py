...
class File_Operation:
    ...
    def save_model(self,model,filename):
        ...
        try:
            ...
            self.logger_object.log(self.file_object,'Model File '+filename+' could not saved. Exited the save_model method of the Model_Finder class')
            raise Exception()


    def load_model(self,filename):
        self.logger_object.log(self.file_object,'Entered the load_model method of File_Operation class')
        try:
            with open(self.model_directory+filename+'/'+filename+ '.sav','rb') as f:
                self.logger_object.log(self.file_object,
                                       'Model File '+filename+ ' loaded. Exited the load_model method of Model_Finder class')
                return pickle.load(f)

        except Exception as e:
            self.logger_object.log(self.file_object,
                                   'Exception ocuured in load_model method of Model_Finder class. Exception message :'+str(e))
            self.logger_object.log(self.file_object,
                                   'Model File '+filename+' could not be saved. Exited the load_model method of Model_Finder class')
            raise Exception()
    ...
    def find_correct_model_file(self,cluster_number):
        ...
        try:
            ...
            self.logger_object.log(self.file_object,
                                   'Exception ocuured in find_correct_model_file method of Model_Finder class. Exception message :'+str(e))
            self.logger_object.log(self.file_object,
